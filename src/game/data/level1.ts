...
export const levelOne: LevelData = {
  ...
  platforms: [
    ...
    { id: "z3-tower-base", kind: "static", x: 3584, y: 608, width: 192, height: 112 },
    { id: "z3-tower-body", kind: "static", x: 3616, y: 368, width: 96,  height: 240 },
    { id: "z3-tower-top",  kind: "static", x: 3584, y: 304, width: 160, height: 32  },
    { id: "z3-safe",       kind: "static", x: 3856, y: 608, width: 224, height: 112 },
